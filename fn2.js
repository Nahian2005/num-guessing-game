...
if(guessingnum == num){
    ...
    d=document.write("Number of tries:" + numberofwon + "<br/>" + "<h5> A genius is always a genius. <h5/>" );
   ...
   numberoflose++
   document.write("Number of tries:  " + numberoflose + " <h5> This was expected. This user is so dumb that he cannot guess a correct number!LOL!! <h5/>" );
